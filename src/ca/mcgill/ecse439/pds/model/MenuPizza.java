...
public class MenuPizza extends Pizza {
	...
	public MenuPizza(double aPrice, PizzaDeliveryManager aPizzaDeliveryManager, String aName, int aCalorieCount,
	...
	public String toString() {
		return super.toString() + "[" + "name" + ":" + getName() + "," + "calorieCount" + ":" + getCalorieCount() + "]";
	}
}