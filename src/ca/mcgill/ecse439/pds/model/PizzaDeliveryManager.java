...
public class PizzaDeliveryManager
{
  ...
  {
    Pizza aNewPizza = new Pizza(aPrice, this, allIngredients);
    return aNewPizza;
  }
  ...
  public boolean addPizza(Pizza aPizza)
  {
    ...
    boolean isNewPizzaDeliveryManager = existingPizzaDeliveryManager != null && !this.equals(existingPizzaDeliveryManager);

    if (isNewPizzaDeliveryManager && existingPizzaDeliveryManager.numberOfPizzas() <= minimumNumberOfPizzas())
    {
      return wasAdded;
    }
  ...
  public boolean removePizza(Pizza aPizza)
  {
    ...
    //pizzaDeliveryManager already at minimum (1)
  ...
  {
    Ingredient aNewIngredient = new Ingredient(aName, aPrice, this);
  ...
  public boolean addIngredient(Ingredient aIngredient)
  {
    ...
    if (isNewPizzaDeliveryManager && existingPizzaDeliveryManager.numberOfIngredients() <= minimumNumberOfIngredients())
    {
      return wasAdded;
    }
    if (isNewPizzaDeliveryManager)
  ...
  public Order addOrder(String aCustomerName, String aPhoneNumber, String aEmail, String aAddress, Pizza... allPizzas)
  {
