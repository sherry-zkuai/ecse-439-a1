...
public class Pizza
{
  ...
  {
    boolean wasSet = false;
    //Must provide pizzaDeliveryManager to pizza
    if (aPizzaDeliveryManager == null)
    {
      return wasSet;
    }

    if (pizzaDeliveryManager != null && pizzaDeliveryManager.numberOfPizzas() <= PizzaDeliveryManager.minimumNumberOfPizzas())
    {
      return wasSet;
    }
    ...
    {
      boolean didRemove = existingPizzaDeliveryManager.removePizza(this);
      if (!didRemove)
      {
